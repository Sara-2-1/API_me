...
public class C03_GetMovies extends MovieDBBaseUrl {
    ...
    void getMoviesTest() {
        ...
        response
                ...
                .body("page", equalTo(1)) // 1. Verify page field = 1
                .body("results.name", hasItems("Peacemaker", "One-Punch Man")) // 2. Check names exist
                .body("results[0].overview", containsString("Ed Gein")) // 3. Overview contains substring
                .body("results", hasSize(20)) // 4. Array size = 20
                .body("results.find{it.name=='Game of Thrones'}.vote_count", greaterThan(25000)) // 5. Game of Thrones votes > 25000
                .body("results", instanceOf(List.class)); // 6. 'results' is a list
    }
}
